...
2. Fill in the values for the `kube-proxy` config and then apply the manifest.
   ```shell
   export ADVERTISE_ADDRESS=2000:192:168:56::11
...
4. Install CoreDNS using the [CoreDNS Helm chart].
   ...
   ```
5. Install a CNI addon, you have several choices:
   ...
   3. Another alternative, install `kube-router` addon, which also provides
      ...
      7. Fill in placeholders then apply the manifest:
         ```shell
         CLUSTERCIDR=fd12:3456:789a:2000::/112,10.96.0.0/16 \
         ...
         #  --enable-ipv4
         #  --enable-ipv6
         #  --service-cluster-ip-range="fd12:3456:789a:2000::/112"
         #  --service-cluster-ip-range="10.96.0.0/16"
         ```
6. Test that DNS resolution for the cluster is working:
