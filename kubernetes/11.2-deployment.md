...
Manages a set of Pods to run an application workload. This is probably the most common way to deploy Podsainly due to its self-healing property of replication.
