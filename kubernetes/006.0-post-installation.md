...
A series of check to you can perform to verify that your cluster is working
as expected. Then adding some tools to aid in disaster recover if and when
needed.
...
[Cluster Backups]: /kubernetes/006.1-cluster-backups.md
