...
You're only allowed to access the following resources:
...
NOTE: There are 2 ways to view the specs for a resource.

1. https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/
2. https://kubernetes.io/docs/reference/kubernetes-api/

The difference being the first allows you to choose which version of Kubernetes
you are working with. While the second link, if you use the search, always takes
you to the latest version.

The first link can be hard to get to, so memorize the link and learn how to use
this to make YAML manifest. It will be invaluable in real-world situations. It
also has references to older versions of specific specs. For example
``
...
[here]: https://docs.linuxfoundation.org/tc-docs/certification/certification-resources-allowed#certified-kubernetes-administrator-cka-and-certified-kubernetes-application-developer-ckad