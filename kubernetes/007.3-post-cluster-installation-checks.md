# Post Cluster Installation Checks

A series of actions to perform immediately after cluster installation to verify
it is working as properly.

## Secrets
Verify we can make a secret:

1. Make and retrieve a secret 
  ```shell
