...
Manages a set of Pods to run an application workload. This is probably the most common way to deploy Pod, mainly due to its self-healing property of replication.
