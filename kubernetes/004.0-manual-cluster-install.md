...
Just in case things don't work out, and you get to a point where you can't seem
to move forward. You can try to reset without spinning up new virtual machines:
...
# remove all cluster static pods, and give the kubelet like 1-2 minutes.
sudo rm -rf /etc/kubernetes/manifests/*.yaml
# Cleanup of CNI configuration.
sudo rm -rf /etc/cni/net.d
# stop the kubelet service
sudo systemctl stop kubelet.service
# Remove the etcd database
sudo rm -rf /var/lib/etcd/*

# optionally clear all journal logs on these VMs. Only in dev and NEVER in
# production.
...
[Install containerd: Manual Installation]: /kubernetes/003.3-install-containerd.md
