...
Another utility to investigate sockets. Use it to see what ports are in use.
...
Usage: ss [ OPTIONS ]
   ...
   -n, --numeric       do n't resolve service names
...
Show all sockets bound to a port and are in a listening state.

```shell
ss -al
```

Filter by IPv6 or IPv4
