...
Thus, it makes the decision which node a Pods should be placed; however, it does
not actually place them.
...
Next: [Cluster Component kube-proxy]

---

[Cluster Component kube-proxy]: /kubernetes/001.6-kube-proxy.md
