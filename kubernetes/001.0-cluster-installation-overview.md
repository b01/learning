...
## Manual Cluster Install Overview
...
## Setup Tool Cluster Install Overview
...
It does a lot of the heavily lifting for initial deployment and upgrading.

This tool is likely what you would use at a real job, though this guide still
leave a lot of manual steps to aid in your learning. Otherwise, there would
be one automated script GUI wizard to kick things off.
